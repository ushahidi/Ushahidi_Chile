...
<div class="bg">
    ...
    <div class="content-wrap clearfix">
        ...
        <div class="two-col tc-right stats-sidebar">
            ...
            <div style="clear:both;"></div>
            <br/><br/><br/><br/>
            <div style="float:right;width:380px;"><h4>Distribution by Parent Categories</h4><?php echo $parents_reports_chart; ?></div>
        ...
        <div style="clear:both;"></div>
        <div>
	        <h4>Distribution by Parent Categories</h4>
	        <p>
	        	<div style="float:left;"><?php echo $parents_reports_chart; ?></div>
	        	<div style="float:left;">
	        		<table>
	        			<?php
	        			foreach($reports_per_parent_cat as $category_id => $count){
	            			?>
	            			<tr>
	            				<td><div id="little-color-box" style="background-color:#<?php echo $category_data[$category_id]['category_color']; ?>">&nbsp;</div></td>
	            				<td><?php echo $category_data[$category_id]['category_title']; ?></td>
